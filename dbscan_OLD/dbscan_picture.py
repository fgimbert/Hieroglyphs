# -*- coding: utf-8 -*-
"""
Created on Wed Mar 16 12:26:30 2016
...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar  9 11:09:31 2016
...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar  8 19:39:46 2016
...
hiero = ndimage.imread("picture.jpg")
image = color.rgb2gray(hiero)


hiero_ent = np.where(image<0.5, 1,0)
...
idx=0        
for i in range(hiero_ent.shape[0]):
    for j in range(hiero_ent.shape[1]):
        if hiero_ent[i,j]==0:
            hiero_p[idx,0]=i
            hiero_p[idx,1]=j
            idx+=1
...
y_db, Nc = nn.scanCluster(8,10)

print(time.clock() - t0, "seconds process time")


#hiero_c=hiero_ent.copy()

#hiero_c = np.where(hiero_ent<5.9, 255, hiero_ent)
...
plt.savefig('hiero_dbscan_try.png', dpi=200)
plt.show()
